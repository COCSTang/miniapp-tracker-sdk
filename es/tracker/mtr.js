...
export var MTR = function () {
    function MTR(config) {
        ...
        this.referrerAppId = '-';
        this.refActionList = [];
        this.stat_app_launch = true;
        this.stat_app_show = true;
        ...
        */
        ...
        value: function appEvent(event) {
            ...
            var send = function send() {
                _this2.mtrDebug && logger("appEvent", param);
                var param4 = param;
                param4.refAction = _this2.refAction;
                _this2.refAction = event;
                return _this2._remoteLog({
                    timestamp: timestamp,
                    seedId: _this2.cfg.clkSeedId,
                    param1: "",
                    param2: event,
                    param3: "",
                    param4: param4
        ...
        value: function api(param) {
            ...
            my.reportAnalytics(param2.toLowerCase(), { api: api, success: success, bizSuccess: bizSuccess, time: time, code: code, msg: msg, response: response });
            return this._remoteLog({
